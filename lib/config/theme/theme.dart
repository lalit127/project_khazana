...
import 'package:practical_khazana/config/theme/app_colors.dart';
import 'package:practical_khazana/config/theme/app_sizes.dart';
import 'package:practical_khazana/utils/base_fonts.dart';
...
class AppThemes {
  ...
  static final ThemeData lightTheme = ThemeData(
    textSelectionTheme: TextSelectionThemeData(
      ...
      selectionColor: AppColors.appWhiteColor.withOpacity(0.5),
      selectionHandleColor: AppColors.appWhiteColor,
    ),
